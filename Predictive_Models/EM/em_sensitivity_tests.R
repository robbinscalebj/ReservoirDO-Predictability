...
source(here("Predictive_Models/EM/em_randfor_recipes.R"))
...
randfor_best <- readRDS(here("Predictive_Models/EM/randfor_tuneresults_lag0.Rds")) |> 
...
rf_rmse_results_trans|>write_csv(here("Predictive_Models/EM/training_data_size_sensitivity_results.csv"))
#rf_rmse_results_trans<-read_csv(here("Predictive_Models/EM/training_data_size_sensitivity_results.csv"))
...
rf_predictions_sw1|>write_csv(here("Predictive_Models/EM/split_switch_sensitivity_preds.csv"))
...
predictions_c|>write_csv(here("Predictive_Models/EM/split_switch_sensitivity_results.csv"))

#################################### TEST 3 ######################################
# Downsampling our training set to match the limitations in the Fayetteville data
# Fayetteville could only be sampled from 19:00 to 05:00 due to electrical issue - EM data are in UTC so have to exclude corresponding +6 hour
...
predictions_ds_c|>write_csv(here("Predictive_Models/EM/downsampling_sensitivity_results.csv"))
