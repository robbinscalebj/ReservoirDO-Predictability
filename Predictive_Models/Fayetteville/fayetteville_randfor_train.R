...
here::i_am("Predictive_Models/Fayetteville/fayetteville_randfor_train.R")

source(here("Predictive_Models/Fayetteville/fayetteville_randfor_recipes.R")) #reads data and recipes
...
saveRDS(randfor_mods, file = here("Predictive_Models/Fayetteville/randfor_mods.Rds"))

## to read back in, and have objects in environment, as needed for code below
#randfor_mods <- readRDS(here("Predictive_Models/Fayetteville/randfor_mods.Rds"))
...
randfor_predselect_plot <- randfor_best_results|>
  ...
  ggtitle("fayetteville hyperparameter tuning")

randfor_predselect_plot
#best is lag0 with no interactions. Basically complete overlap with lag72, and lag 24, but simpler to choose lag0

saveRDS(randfor_lag0_tuned, file = here("Predictive_Models/Fayetteville/randfor_tuneresults_lag0.Rds"))
...
write_csv(final_vi, here("Predictive_Models/Fayetteville/randfor_lag0_vip_scores.csv"))
saveRDS(final_randfor, here("Predictive_Models/Fayetteville/randfor_fit.Rds"))
final_randfor <- readRDS(here("Predictive_Models/Fayetteville/randfor_fit.Rds"))
...
rsq(final_randfor_preds, truth = DO_mg.L, estimate = .pred)
