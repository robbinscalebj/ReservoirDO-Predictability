...
here::i_am("Predictive_Models/Maumelle/maumelle_randfor_train.R")

source(here("Predictive_Models/Maumelle/maumelle_randfor_recipes.R")) #reads data and recipes
...
saveRDS(randfor_mods, file = here("Predictive_Models/Maumelle/randfor_mods.Rds"))

## to read back in, 
#randfor_mods <- readRDS(here("Predictive_Models/Maumelle/randfor_mods.Rds"))
...
randfor_predselect_plot <- randfor_best_results|>
  ...
  ggtitle("maumelle hyperparameter tuning")

randfor_predselect_plot
#best is lag0 with no interactions. Basically complete overlap with lag72 no interaction, but simpler to choose lag0
saveRDS(randfor_lag0_tuned, file = here("Predictive_Models/Maumelle/randfor_tuneresults_lag0.Rds"))
...
write_csv(final_vi, here("Predictive_Models/Maumelle/randfor_lag0_vip_scores.csv"))
saveRDS(final_randfor, here("Predictive_Models/Maumelle/randfor_fit.Rds"))
final_randfor <- readRDS(here("Predictive_Models/Maumelle/randfor_fit.Rds"))
